...
SIGNAL_AUTO_TUNE_MIN_SAMPLES=250
...
# Flow migration mode (set false only during migration/rollback windows)
FLOW_CANONICAL_ONLY=true
...
# Upsert symbol metadata into required symbols table

...
api-test: ## Test ALL API endpoints
	...
	@echo ""
	@BASE_URL="http://localhost:8000"; 	SYMBOL="SPY"; 	TIMEFRAME="5min"; 	test_endpoint() { 		label="$$1"; 		url="$$2"; 		echo "$(BLUE)━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━$(NC)"; 		echo "$(GREEN)$${label}:$(NC)"; 		echo "$(BLUE)━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━$(NC)"; 		curl -s "$$url" | python -m json.tool || echo "$(RED)✗ Failed$(NC)"; 		echo ""; 	}; 	test_endpoint "Health Check" "$$BASE_URL/api/health"; 	test_endpoint "GEX Summary" "$$BASE_URL/api/gex/summary?symbol=$$SYMBOL"; 	test_endpoint "GEX by Strike (Top 10)" "$$BASE_URL/api/gex/by-strike?symbol=$$SYMBOL&limit=10"; 	test_endpoint "GEX Historical (Last 10)" "$$BASE_URL/api/gex/historical?symbol=$$SYMBOL&limit=10&timeframe=$$TIMEFRAME"; 	test_endpoint "Max Pain Timeseries (Last 10)" "$$BASE_URL/api/max-pain/timeseries?symbol=$$SYMBOL&limit=10&timeframe=$$TIMEFRAME"; 	test_endpoint "Max Pain Current" "$$BASE_URL/api/max-pain/current?symbol=$$SYMBOL&strike_limit=100"; 	test_endpoint "Option Flow by Type" "$$BASE_URL/api/flow/by-type?symbol=$$SYMBOL&window_minutes=60"; 	test_endpoint "Option Flow by Strike (Top 10)" "$$BASE_URL/api/flow/by-strike?symbol=$$SYMBOL&window_minutes=60&limit=10"; 	test_endpoint "Smart Money Flow" "$$BASE_URL/api/flow/smart-money?symbol=$$SYMBOL&window_minutes=60&limit=10"; 	test_endpoint "Flow Timeseries" "$$BASE_URL/api/flow/timeseries?symbol=$$SYMBOL&timeframe=$$TIMEFRAME"; 	test_endpoint "Current Market Quote" "$$BASE_URL/api/market/quote?symbol=$$SYMBOL"; 	test_endpoint "Previous Close" "$$BASE_URL/api/market/previous-close?symbol=$$SYMBOL"; 	test_endpoint "Historical Quotes (Last 10)" "$$BASE_URL/api/market/historical?symbol=$$SYMBOL&limit=10&timeframe=$$TIMEFRAME"; 	test_endpoint "VWAP Deviation" "$$BASE_URL/api/trading/vwap-deviation?symbol=$$SYMBOL&limit=10"; 	test_endpoint "Opening Range Breakout" "$$BASE_URL/api/trading/opening-range?symbol=$$SYMBOL&limit=10"; 	test_endpoint "Gamma Exposure Levels" "$$BASE_URL/api/trading/gamma-levels?symbol=$$SYMBOL&limit=10"; 	test_endpoint "Dealer Hedging Pressure" "$$BASE_URL/api/trading/dealer-hedging?symbol=$$SYMBOL&limit=10"; 	test_endpoint "Unusual Volume Spikes" "$$BASE_URL/api/trading/volume-spikes?symbol=$$SYMBOL&limit=10"; 	test_endpoint "Momentum Divergence" "$$BASE_URL/api/trading/momentum-divergence?symbol=$$SYMBOL&limit=10"; 	test_endpoint "GEX Heatmap" "$$BASE_URL/api/gex/heatmap?symbol=$$SYMBOL&timeframe=$$TIMEFRAME&window_minutes=60&interval_minutes=5"; 	test_endpoint "Price Timeseries" "$$BASE_URL/api/price/timeseries?symbol=$$SYMBOL&timeframe=$$TIMEFRAME"; 	test_endpoint "Swagger UI Availability" "$$BASE_URL/docs"; 	test_endpoint "ReDoc Availability" "$$BASE_URL/redoc"; 	test_endpoint "OpenAPI JSON" "$$BASE_URL/openapi.json"; 	echo "$(BLUE)━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━$(NC)"; 	echo "$(GREEN)✅ All API Endpoints Tested$(NC)"; 	echo "$(BLUE)━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━$(NC)"; 	echo ""; 	echo "$(YELLOW)API Documentation available at:$(NC)"; 	echo "  • Swagger UI: $$BASE_URL/docs"; 	echo "  • ReDoc:      $$BASE_URL/redoc"; 	echo "  • OpenAPI:    $$BASE_URL/openapi.json"; 	echo ""
